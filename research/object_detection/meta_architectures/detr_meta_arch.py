...
################################## UTILITY FUNCTIONS ########################################
  ...
  def _postprocess_box_classifier(self,
    ...
    refined_decoded_boxes_batch = ops.normalized_to_image_coordinates(tf.squeeze(refined_decoded_boxes_batch), image_shape=orig_image_shapes, temp=True)
    refined_decoded_boxes_batch = tf.expand_dims(refined_decoded_boxes_batch, axis)
