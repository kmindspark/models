...
class DETRMetaArch(model.DetectionModel):
  def __init__(self,
    ...
    self.transformer = detr_lib_revert.Transformer(self.transformer_args)#detr_lib.Transformer(attention_dropout=0.0, layer_postprocess_dropout=0.0, relu_dropout=0.0)
